...
class Projects extends MY_Controller
{
    ...
    function __newProject()
    {
        ...
        //services list
        $this->data['lists']['services'] = create_pulldown_list($this->projects_model->list_services(), 'services', 'id');
    ...
    function __flmFormValidation($form = '')
    {
        ...
        if ($form == 'add_project') {
            ...
            /*$fields = array(
                ...
                'project_service' => $this->data['lang']['lang_service'],
