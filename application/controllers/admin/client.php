...
class Client extends MY_Controller
{
    ...
    function __clientDetails()
    {
        ...
        if ($next) {
            ...
            //unpaid invoices
            $this->data['vars']['client_count_unpaid_invoices'] = $this->invoices_model->countInvoices($this->client_id, 'client', 'all-open');
    ...
    function __clientProfile()
    {
        ...
        //if fomr post, use post data instead to populate the form
