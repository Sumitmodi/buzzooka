...
class Teammessages extends MY_Controller
{
    ...
    function __addMessage()
    {
        ...
        if ($next) {
            ...
            if ($this->team_messages_model->addMessage()) {
    ...
    function __addReply()
    {
        ...
        if ($next) {
            ...
            if ($this->team_message_replies_model->addMessage()) {
    ...
    function __emailer($email = '', $vars = array())
    {
        ...
        if ($email == 'mailqueue_new_message') {
            ...
            for ($i = 0; $i < count($this->data['vars']['project_team_mailing_list']); $i++) {
                ...
                $this->data['email_vars']['addressed_to'] = $this->data['vars']['project_team_mailing_list'][$i]['name'];
