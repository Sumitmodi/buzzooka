...
class File extends MY_Controller
{
    ...
    function __fileView()
    {
        ...
        if ($next) {
            ...
            if($this->data['fields']['file']['files_islink'])
            {
                $this->data['visible']['video'] = 1;
            } else 
            {
                $this->data['visible']['video'] = 0;
                if (in_array($this->data['fields']['file']['files_extension'], $preview_extensions)) {
                    $this->data['visible']['wi_file_preview_image'] = 1;
                }else if (in_array($this->data['fields']['file']['files_extension'], $video_extensions)){
