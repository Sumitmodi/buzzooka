...
class MY_Controller extends CI_Controller
{
     ...
     * @return void
     */
    function __commonAll_ProjectBasics($project_id)
    {
        ...
        if ($next) {
            ...
            $this->project_details['project_deadline'] = !empty($this->project_details['projects_end']) ? $this->project_details['projects_end'] : $this->project_details['project_deadline'];
            $this->project_details['projects_end'] = !empty($this->project_details['projects_end']) ? $this->project_details['projects_end'] : $this->project_details['project_deadline'];

            $this->project_details['projects_title'] = !empty($this->project_details['services_name']) ? $this->project_details['services_name'] : $this->project_details['projects_title'];
            $this->project_details['services_name'] = !empty($this->project_details['services_name']) ? $this->project_details['services_name'] : $this->project_details['projects_title'];
            //ends here
    ...
    /**
     * Checks if the current use is admin or not
     * @return bool
     */
    private function isAdmin()
    {
        if (false == $this->session->userdata('groups_name')) {
            return false;
        }
        return strtolower($this->session->userdata('groups_name')) == 'administrator';
    }
    ...
    function __preRun_Arrays()
    {
        ...
        if ($this->isAdmin()) {
            $this->data['common_arrays']['permission_categories'][] = 'team';
        }
        /** timer updates
         */
